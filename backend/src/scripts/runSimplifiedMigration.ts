...
async function runSimplifiedMigration() {
  ...
  try {
    ...
    console.log("⚠️  WARNING: This will migrate your roles structure!");
    ...
    console.log("✅ Simplified roles migration completed successfully!");
    console.log("\n⚠️  IMPORTANT: Verify the migration worked correctly before dropping old tables.");
    console.log("⚠️  Old tables are backed up as: user_roles_backup, user_roles_old, roles");
    process.exit(0);
  } catch (error) {
