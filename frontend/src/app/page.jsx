...
export default function Home() {
  ...
  return (
    <>
      <Nav />
      <section className="flex min-h-screen items-center justify-center space-y-6 pb-8 pt-6  md:pb-12 md:pt-10 lg:py-32 bg-gradient-to-b from-gray-100 to-white">
